# Generated by Django 3.1.1 on 2020-09-10 17:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='책 이름을 입력하세요', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', '보수중'), ('o', '대여중'), ('a', '대여가능'), ('r', '예약중')], default='m', help_text='Book availability', max_length=1)),
